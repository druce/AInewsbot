...
- Also searches for AI news on a bunch of sites using [newscatcher](https://www.newscatcherapi.com/)  and [newsapi](https://[www.newscatcherapi.com/](https://newsapi.org/docs/get-started)) (see my [marketdata](https://github.com/druce/marketdata) repo for some other news APIs)
